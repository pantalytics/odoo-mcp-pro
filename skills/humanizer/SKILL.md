---
name: humanizer
description: Remove signs of AI-generated writing from text. Use when drafting or editing user-facing copy in Odoo (emails, product descriptions, website pages, knowledge articles, chatter messages) so it reads natural and human-written. Based on Wikipedia's "Signs of AI writing" guide.
triggers: [humanize, humanizer, ai-generated, ai writing, ai text, ai tell, ai-sounding, em dash, slop, herschrijf, menselijk, robotisch]
license: MIT
---
